...
def run_match(map_name, p1_bot_name, p2_bot_name, replay_file_name):
    ...
    game_settings["replay"] = replay_file_name
    ...
    game_result = game.save_replay(save_path, game_settings["replay"])
